...
<script src="{{asset('assets/app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/app-assets/vendors/js/tables/buttons.flash.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/app-assets/vendors/js/tables/jszip.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/app-assets/vendors/js/tables/pdfmake.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/app-assets/vendors/js/tables/vfs_fonts.js')}}" type="text/javascript"></script>
...
<script src="{{asset('assets/app-assets/js/scripts/customizer.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/app-assets/vendors/js/jquery.sharrre.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/app-assets/js/scripts/tables/datatables/datatable-advanced.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('assets/app-assets/js/scripts/forms/form-repeater.min.js')}}" type="text/javascript"></script>
<script>
  // console.log($.app.menu);
  // $(document).ready(function(){setInterval(function(){$.app.menu.collapse()},100)});
</script>
<!-- END: Page JS-->
@yield('script')
