<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="{{asset('assets/app-assets/images/backgrounds/02.jpg')}}">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="Chameleon admin logo" src="{{asset('assets/app-assets/images/logo/logo.png')}}"/>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="{{route('kasir.dashboard')}}"><i class="ft-life-buoy"></i><span class="menu-title" data-i18n="">Dashboard</span></a></li>

            <li class=" nav-item"><a href="{{route('kasir.merk.index')}}"><i class="ft-life-buoy"></i><span class="menu-title" data-i18n="">Merk</span></a></li>

            <li class=" nav-item"><a href="{{route('kasir.obat.index')}}"><i class="ft-life-buoy"></i><span class="menu-title" data-i18n="">Obat</span></a></li>

            <li class=" nav-item"><a href="{{route('kasir.transaksi.index')}}"><i class="ft-life-buoy"></i><span class="menu-title" data-i18n="">Transaksi</span></a></li>
