...
@include('templates.partials.apotek._head')
<!-- BEGIN: Body-->
<body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">

@include('templates.partials.apotek._navbar')

<!-- BEGIN: Main Menu-->
@include('templates.partials.apotek._sidebar')
<!-- END: Main Menu-->
...
@include('templates.partials.apotek._script')
</body>
<!-- END: Body-->
</html>