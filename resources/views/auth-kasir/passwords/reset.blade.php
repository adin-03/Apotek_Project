                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ route('kasir.password.update') }}">
                                        @csrf
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="email" readonly class="form-control"name="email" value="{{ $email }}" style="background: white">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input id="password" type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                                                   name="password_confirmation" required autocomplete="current-password" placeholder="Masukkan Konfirmasi Password">
